    ...
    def build_connector_meta(
        ...
        for request_id, (
            ...
            if request_id not in request_ids and request_id not in cached_reqs.req_ids:
                ...
                # A lookup can be rejected in favor of another connector.
                # Only the chosen connector may issue this pending load;
                # normal saves use SchedulerOutput once actually scheduled.
